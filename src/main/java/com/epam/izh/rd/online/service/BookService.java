...
public interface BookService<T extends Book> {
     ...
     * То есть вы должен взять имя и фамилию автора из книги и обратиться к сервису
     * авторов и узнать о наличии такого автора.
     * Напомню, что мы считаем, что двух авторов с одинаковыми именем и фамилией быть
     * не может.
     *
     ...
     *
     * Соответственно, если книга была успешно сохранена - метод возвращает true, если
     * же книга не была сохранена - метод возвращает false.
     */
    boolean save(T book);
